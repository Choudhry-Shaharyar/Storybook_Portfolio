...
const Contact: React.FC = () => {
  return (
    <footer id="contact" className="bg-black text-white pt-24 pb-12 border-t-4 border-blue-600 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <ComicPanel variant="white" className="text-left group cursor-pointer hover:bg-blue-50 transition-colors">
            <h3 className="font-bold font-heading text-xl mb-4 text-black uppercase">Get in Touch</h3>
            <div className="space-y-4">
              <a href="mailto:shaharyar.choudhry7@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
                <Mail size={20} />
                <span className="font-medium">shaharyar.choudhry7@gmail.com</span>
              </a>
              <a href="tel:647-667-7804" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
                <Phone size={20} />
          ...
          <ComicPanel variant="white" className="text-left group cursor-pointer hover:bg-blue-50 transition-colors">
             ...
             <div className="space-y-4">
              <a href="https://linkedin.com/in/shaharyar-choudhry" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
                <Linkedin size={20} />
                <span className="font-medium">linkedin.com/in/shaharyar-choudhry</span>
              </a>
              <a href="https://shaharyarchoudhry.me" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
                <Globe size={20} />
