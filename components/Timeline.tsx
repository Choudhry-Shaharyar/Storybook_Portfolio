      ...
      >
        ...
        <ComicPanel className="relative z-0">
          <div className="flex flex-col gap-2 mb-4">
            <span className="font-bold text-green-600 uppercase tracking-widest text-sm">{chapter.title}</span>
          ...
          <div className="space-y-3 mb-6">
            {chapter.achievements.map((ach, i) => (
              <div key={i} className="flex items-start gap-2">
                <div className="mt-1.5 w-1.5 h-1.5 bg-green-600 rounded-full shrink-0" />
